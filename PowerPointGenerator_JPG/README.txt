...
that exist in the following structure:
		...
		directory structure: "Output 20xxxxxx//[Any Folder]//images//pre_6_l.jpg"

PowerPointGenerator.exe goes through all "Any Folder" in the folder "Output 20xxxxxx" and finds all the images named "pre_6_l.jpg"
...
If the folder "Output 20xxxxxx" contains folders that contain folder "images", which in turn contains the image file "pre_6_l.jpg",
